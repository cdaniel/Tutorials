/**
 */
package org.xtext.example.mydsl.insurance.util;
...
public class InsuranceAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected InsuranceSwitch<Adapter> modelSwitch =
    new InsuranceSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.mydsl.insurance.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.mydsl.insurance.Product <em>Product</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
